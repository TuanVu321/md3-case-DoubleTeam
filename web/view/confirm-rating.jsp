...
<div class="container">
    <div class="formConfirm">
        <h1 class="not-login">Bạn Đã Chấm Điểm thành công cho bài viết, hãy quay lại danh sách các bài viết để tìm hiểu các địa điểm khac </h1>
        <a href="/rating?action=showTop10Star">Xem Bảng Tổng Kết 10 PostReview Có Điểm Cao Nhất  </a>
    </div>
</div>
