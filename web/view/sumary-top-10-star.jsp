...
<div id="contain-dashboard-review" class="formConfirm dashboard">
    <h1>Tổng Kết Những Bài Review Được Người Dùng Đánh Giá Nhiều Sao Nhất </h1>
    <table>
        <thead>
        <tr>
            <th id="stt">STT</th>
            <th id="idbv">ID Bài Viết</th>
            <th id="tbv">Tên Bài Viết</th>
            <th id="td">Tiêu Đề Bài Viết</th>
            <th id="tsd">Tổng Số Điểm Bài Review Đạt Được</th>
        </tr>
        </thead>
        <tbody>
        <c:forEach items="${topList}" var="review">
            <tr>
                <td><%=count++%></td>
                <td>${review.getId_review()}</td>
                <td>${review.getName()}</td>
                <td id="titleReview">${review.getTitle()}</td>
                <td id="">${review.getScoreStar()}</td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
