...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="col-md-12" style="background: white; height: 90px">
                    <div style="margin-top: 10px; margin-right: 10px; margin-bottom: 10px; float: left">
                        <a href="https://bitly.com.vn/AxXo9"><img src="https://bitly.com.vn/rVNml" height="70px" width="70px"
                        style="border-radius: 10px"></a>
                    </div>
                    <div style="float: left; height: 90px">
                        <div style=" margin-top: 10px">
                        <a style="color: black; font-weight: bold; text-decoration: none" href="https://bitly.com.vn/AxXo9">
                        ...
                        <div style="margin-bottom: 10px; font-size: 15px">
                            <p style=" margin-bottom: 0px"><img src="../img/time.png" height="10" width="10"> 5 ngày 4 đêm</p> </div>
                    </div>
            </div>
            <div class="col-md-12" style="background: white; height: 90px; margin-top: 20px">
                <div style="margin-top: 10px; margin-right: 10px; margin-bottom: 10px; float: left">
                    <a href="https://bitly.com.vn/9mlA5"><img src="https://bitly.com.vn/uN7Il" height="70px" width="70px"
                                                              style="border-radius: 10px"></a>
                </div>
                <div style="float: left; height: 90px">
                    <div style=" margin-top: 10px">
                        <a style="color: black; font-weight: bold; text-decoration: none" href="https://bitly.com.vn/9mlA5">
                            <p style=" margin-bottom: 0px; font-size: 16px">
                    ...
                    <div style="margin-bottom: 10px; font-size: 15px">
                        <p style=" margin-bottom: 0px"><img src="../img/time.png" height="10" width="10"> 4 ngày 3 đêm</p> </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="col-md-12" style="background: white; height: 90px">
                <div style="margin-top: 10px; margin-right: 10px; margin-bottom: 10px; float: left">
                    <a href="https://bitly.com.vn/t0buC"><img src="https://bitly.com.vn/bUTI4" height="70px" width="70px"
                                                              style="border-radius: 10px"></a>
                </div>
                <div style="float: left; height: 90px">
                    <div style=" margin-top: 10px">
                        <a style="color: black; font-weight: bold; text-decoration: none" href="https://bitly.com.vn/t0buC">
                            <p style=" margin-bottom: 0px; font-size: 16px">
            ...
            <div class="col-md-12" style="background: white; height: 90px; margin-top: 20px">
                <div style="margin-top: 10px; margin-right: 10px; margin-bottom: 10px; float: left">
                    <a href="https://bitly.com.vn/AU2ug"><img src="https://bitly.com.vn/K6EaJ" height="70px" width="70px"
                                                              style="border-radius: 10px"></a>
                </div>
                <div style="float: left; height: 90px">
                    <div style=" margin-top: 10px">
                        <a style="color: black; font-weight: bold; text-decoration: none" href="https://bitly.com.vn/AU2ug">
                            <p style=" margin-bottom: 0px; font-size: 16px">
        ...
        <div class="col-md-4">
            <div class="col-md-12" style="background: white; height: 90px">
                <div style="margin-top: 10px; margin-right: 10px; margin-bottom: 10px; float: left">
                    <a href="https://bitly.com.vn/FcdqI"><img src="https://bitly.com.vn/rdeKb" height="70px" width="70px"
                                                              style="border-radius: 10px"></a>
                </div>
                <div style="float: left; height: 90px">
                    <div style=" margin-top: 10px">
                        <a style="color: black; font-weight: bold; text-decoration: none" href="https://bitly.com.vn/FcdqI">
                            <p style=" margin-bottom: 0px; font-size: 16px">
            ...
            <div class="col-md-12" style="background: white; height: 90px; margin-top: 20px">
                <div style="margin-top: 10px; margin-right: 10px; margin-bottom: 10px; float: left">
                    <a  href="https://bitly.com.vn/gKLEI"><img src="https://bitly.com.vn/GHBuD" height="70px" width="70px"
                                                              style="border-radius: 10px"></a>
                </div>
                <div style="float: left; height: 90px">
                    <div style=" margin-top: 10px">
                        <a style="color: black; font-weight: bold; text-decoration: none" href="https://bitly.com.vn/gKLEI">
                            <p style=" margin-bottom: 0px; font-size: 16px">
